...
export class KategoriComponent implements OnInit {
  ...
  KategoriEkleDuzenle() {
    ...
    if (!kat.id) {
      ...
      if (filtre.length > 0) {
        ...
        this.sonuc.mesaj = "Girilen Marka Kayıtlıdır!";
        ...
        this.servis.KategoriEkle(kat).subscribe(d => {
          ...
          this.sonuc.mesaj = "Marka Eklendi";
          this.toast.ToastUygula(this.sonuc);
          this.KategoriListele();
          this.modal.toggle();
        });
      ...
      this.servis.KategoriDuzenle(kat).subscribe(d => {
        this.sonuc.islem = true;
        this.sonuc.mesaj = "Marka Düzenlendi";
        this.toast.ToastUygula(this.sonuc);
        this.KategoriListele();
        this.modal.toggle();
      });
  ...
  KategoriSil() {
    this.servis.KategoriSil(this.secKat.id).subscribe(d => {
      this.sonuc.islem = true;
      this.sonuc.mesaj = "Marka Silindi";
      this.toast.ToastUygula(this.sonuc);
      this.KategoriListele();
      this.modal.toggle();
    });
